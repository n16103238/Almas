      ...
      <!-- Users -->
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                <a class="dropdown-item" href="{{route('user_list')}}"><i class="fas fa-user-md"></i>
                  <span>User List</span></a>
                <a class="dropdown-item" href="{{route('add_role')}}"><i class="fas fa-plus-circle"></i>
                  <span>Add Role</span></a>
                  <a class="dropdown-item" href="{{route('role_list')}}"><i class="fas fa-file-contract"></i>
